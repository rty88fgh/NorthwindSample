...
{
    public partial class DataServerContext : DbContext, IDesignTimeDbContextFactory<DataServerContext>
    {
        public DataServerContext()
        {
        }

        public DataServerContext(DbContextOptions<DataServerContext> options)
            : base(options)
        {
        }
        ...
        public DataServerContext CreateDbContext(string[] args)
        {
            var optionBuilder = new DbContextOptionsBuilder<DataServerContext>();
            optionBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Integrated Security=true;");
            return new DataServerContext(optionBuilder.Options);
        }
